            ...
            <div class="row setup-content" id="step-1">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Género <span class="required">*</span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control border-form-control" value=""
                                       name="document_number" placeholder="123456789123A" type="text">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row setup-content" id="step-2">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Província <span class="required">*</span></label>
